...
<body>
    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <form action="adminStudentAction.php" method="post" enctype="multipart/form-data">
        ...
        <table class="studenttable table-hover" id="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="adminStudentDetails.php?details=<?= $row['id']; ?>" class="badge badge-success p-2">Details</a> |
                <a href="adminStudentAction.php?delete=<?= $row['id']; ?>" class="badge badge-success p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> |
                <a href="adminStudent.php?edit=<?= $row['id']; ?>" class="badge badge-success p-2">Edit</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
