...
<input type="checkbox" id="check">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <form action="teachersTeacherAction.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-hover " id="data-table"  style="color:white; height: 485px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="teachersTeacherDetails.php?teachersTeacherDetails=<?= $row['id']; ?>" class="badge badge-success p-2">Details</a> |
                <a href="teachersTeacherAction.php?delete=<?= $row['id']; ?>" class="badge badge-success p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> |
