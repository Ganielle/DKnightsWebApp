...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        ?>
        <h3 class="text-center ">Records Present In The Database</h3>
        <table class="studenttable table-hover" id="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="details.php?details=<?= $row['id']; ?>" class="badge badge-success p-2">Details</a> |
                <a href="action.php?delete=<?= $row['id']; ?>" class="badge badge-success p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> |
                <a href="student.php?edit=<?= $row['id']; ?>" class="badge badge-success p-2">Edit</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
