...
include 'adminAddQuestionAction.php';
...
<body>
  ...
  <header>
      ...
      <form action="adminQuestionAction.php" method="post" enctype="multipart/form-data">
      <?php 
    ...
    <div class="">
      ...
      <br> <br>
        ...
        <table class="table table-hover text-light" id="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="adminQuestionAction.php?delete=<?= $row['id']; ?>" class="badge badge-success p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> 
          ...
          <form action="adminAddQuestionAction.php" method="post" enctype="multipart/form-data">          
