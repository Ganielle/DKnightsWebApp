...
if (isset($_POST["submit"])) {
    ...
    if ($photo_size > 5242880) {
        ...
        $sql = "UPDATE student_crud SET  studentphoto='$photo_new_name' WHERE id='{$_SESSION["id"]}'";
...
<body>
    ...
    <header>
        ...
        $sql = "SELECT * FROM student_crud WHERE id='{$_SESSION["id"]}'";
        $result = mysqli_query($conn, $sql);
        ...
        <div class="inputBox">
            ...
            <input type="file" accept="image/*" id="studentphoto" name="photo" class="form-control-file" value="This is some text" required>
        </div>
        <img src="ProfileUploads/<?php echo $row["studentphoto"]; ?>" class="profile-img"   alt="">
        <p><?php echo $row['studentFullname']; ?></p>
        <?php
            }
        }
        ...
        <div>
            <button type="submit" name="submit" class="btn btn-success">Update Profile</button>
                    ...
                    <a href="studentWelcome.php"><i class="fas fa-table"></i><span>Dashboard</span></a>
