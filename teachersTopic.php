                    ...
                    <div class="col-md-8">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <form action="teachersTopicAction.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-hover" id="data-table" style="color:white">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <a href="teachersViewQuestion.php?teachersViewQuestion=<?php echo($trow[0]); ?>" class="badge badge-success p-2" >View questions</a>
                <a href="teachersTopicAction.php?delete=<?php echo($trow[0]); ?>" class="badge badge-success p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> 
              </td>
            </tr>
            <?php } ?>
          </tbody>
