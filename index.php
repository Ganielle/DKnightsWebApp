...
if (isset($_POST["signin"])) {
  ...
  $check_studNum= mysqli_query($conn, "SELECT id FROM student_crud WHERE studentNumber='$studentNumber' AND password='$password' ");
  ...
  if (mysqli_num_rows($check_studNum) > 0) {
    ...
    $_SESSION["id"] = $row['id'];
    $_SESSION['studentFullname'] = $studentFullname;
...
if (isset($_POST["signin"])) {
  ...
  setcookie("studentNumber",$_POST["studentNumber"],time()+time() + 60*60*24*30);
      ...
      <div class="signin-signup">
        ...
        <form action="" method="post" class="sign-in-form">
          ...
          <i class="fas fa-id-card"></i>
            <input type="text" placeholder="Student Number" name="studentNumber" value="<?php echo $_SESSION['studentNumber']; ?>" required />
          </div>
